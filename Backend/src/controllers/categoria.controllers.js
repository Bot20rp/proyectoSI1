import Categoria from '../models/Categoria.js'; 
 ...
 export const insertarCategoriaPadre = async (req, res) => {
  ...
  export const insertarCategoriaHija = async (req, res) => {
    const { Nombre, NombreCategoriaPadre } = req.body; // Cambiar CategoriaPadreID por NombreCategoriaPadre
    // Validar que todos los campos necesarios estén presentes
    if (!Nombre || !NombreCategoriaPadre) {
    ...
    try {
      ...
      const categoriaPadre = await Categoria.findOne({
        where: { Nombre: NombreCategoriaPadre },
      });
